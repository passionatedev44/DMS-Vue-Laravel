  ...
  methods: {
    ...
    createDocument: function createDocument() {
      ...
      _services_factory__WEBPACK_IMPORTED_MODULE_1__["default"].document.create(this.document).then(function (response) {
        ...
        _this8.$toast.success("Already created document");
      })["catch"](function (error) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("CCardHeader", [
        _vm.documentId
          ? _c("strong", [_vm._v("О document")])
          : _c("strong", [_vm._v("Create a document")])
      ]),
      _vm._v(" "),
      _c(
        "CCardBody",
                          ...
                          [
                            {
                              ...
                              fn: function() {
                                return [
                                  _vm._t("label", [
                                    _c("label", [_vm._v("Place of issue")])
                                  ])
                                ]
                              },
                              proxy: true
