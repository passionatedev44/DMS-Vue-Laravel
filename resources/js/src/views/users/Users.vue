    ...
    <CCol col="12">
      <CCard>
        ...
        <CCardBody>
          ...
          >
            <template #title="{item}">
              <td>{{item.title ? item.title.name : 'Indefinite'}}</td>
            </template>
            <template #department="{item}">
              <td>{{item.department ? item.department.name : 'Indefinite'}}</td>
            </template>
          </CDataTable>
          <CPagination
            align="center"
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "department", label: "Subdivision" }
      ],
      searchFields: [
        { value: "", label: "All" },
        { value: "id", label: "Code" },
        ...
        { value: "title.name", label: "Job title" },
        { value: "department.name", label: "Subdivision" },
