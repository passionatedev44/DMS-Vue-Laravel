<template>
  <CCard>
    <CCardHeader>
      <strong v-if="documentId">О document</strong>
      <strong v-else>Create a document</strong>
    </CCardHeader>
    <CCardBody>
      <CForm>
        ...
        <CRow class="form-group">
          <CCol sm="12">
            <CInput label="Registration number" :value.sync="document.symbol" class="mb-0" />
          </CCol>
        </CRow>
        <CRow class="form-group">
          <CCol sm="6">
            <CInput label="Author" :value="document.creator.name" readonly class="mb-0" />
          </CCol>
          <CCol sm="6">
            <CInput label="Author ID" :value="document.creator.name" readonly class="mb-0" />
          </CCol>
        </CRow>
        <CTextarea
          label="Summary"
        ...
        <CRow class="form-group">
          ...
          <CCol sm="6">
            <CInput
              :label="isIncome ? 'Date received' : 'date of issue'"
              type="date"
        ...
        <CRow class="form-group">
          ...
          <CCol sm="6">
            <CInput label="Date of signing" type="date" :value.sync="document.sign_at" class="mb-0" />
          </CCol>
        </CRow>
      </CForm>
    </CCardBody>
    ...
    createDocument() {
      services.document
        ...
        .then(response => {
          ...
          this.$toast.success("Already created document");
        })
        .catch(error => {
          this.toastHttpError(error);
        });
